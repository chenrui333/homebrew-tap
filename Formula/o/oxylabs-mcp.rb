class OxylabsMcp < Formula
  ...
  url "https://files.pythonhosted.org/packages/00/de/676926039b67b2f6d6f09e2e3e4fc2bd23880c20bc5e137985b3f3bd4a42/oxylabs_mcp-0.6.0.tar.gz"
  sha256 "9dbf64fb3833a9ffbdae7fec319054d2aa6b7ce66138edceac7c0a667a8d4e92"
  license "MIT"
  ...
  test do
    ...
    assert_match "OXYLABS_AI_STUDIO_API_KEY is not valid", output
  end
end
