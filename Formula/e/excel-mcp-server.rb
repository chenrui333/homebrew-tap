class ExcelMcpServer < Formula
  include Language::Python::Virtualenv

  desc "MCP server for Excel file manipulation"
  homepage "https://excelmcpserver.com/"
  url "https://files.pythonhosted.org/packages/ec/73/7472df2843504a599ae10e7918fcc7bedf9ba5e64f3e4b075b39498b7802/excel_mcp_server-0.1.7.tar.gz"
  sha256 "b18e46ec72e3221d38303fb4dfc1e6f4aaf695b1f3dab505907e8a7f9cbddae7"
  license "MIT"
...
# ==> /opt/homebrew/Cellar/excel-mcp-server/0.1.7/bin/excel-mcp-server 2>&1
# Traceback (most recent call last):
#   File "/opt/homebrew/Cellar/excel-mcp-server/0.1.7/bin/excel-mcp-server", line 3, in <module>
#     from excel_mcp.__main__ import app
# ModuleNotFoundError: No module named 'excel_mcp'
# /opt/homebrew/Homebrew/Library/Homebrew/ignorable.rb:30:in 'block in Object#raise'
...
#   Actual: 1
  ...
  #   output = pipe_output("#{bin}/excel-mcp-server 2>&1", json, 0)
  #   assert_match "Download an image from a URL and generate a complete favicon set", output
  # end
end
