class Dakora < Formula
  include Language::Python::Virtualenv

  desc "Manage and hot-reload prompts with typed inputs and zero-deploy updates"
  homepage "https://dakora.io/"
  ...
  resource "litellm" do
    url "https://files.pythonhosted.org/packages/90/52/2853febf8ea3072d8c76e3ee22d3168e6a4f97ebd8f21905e815a381c58b/litellm-1.79.0.tar.gz"
    sha256 "f58bb751222ee0e1ffecb2d44987999f9fa94130a6d1a478e19a3e5e8b9a7414"
  end
  ...
  test do
    system bin/"dakora", "init"
    assert_path_exists testpath/"prompts"
    assert_match "registry: local", (testpath/"dakora.yaml").read

    assert_match "summarizer", shell_output("#{bin}/dakora list")
  end
end
