class Ifstate < Formula
  ...
  url "https://codeberg.org/liske/ifstate/archive/2.3.0-pre6.tar.gz"
  sha256 "328f5762f3a9bae24bd5e72bce36a7c1ac6ceca063af3a5f9bf608e7c1f0f49e"
  license "MIT"
  head "https://codeberg.org/liske/ifstate.git", branch: "master"

  bottle do
    root_url "https://ghcr.io/v2/chenrui333/tap"
    sha256 cellar: :any_skip_relocation, arm64_linux:  "bbf437699ec3eeb694ca49a1baaa6da1dfec5d0ef2d0cb00d3fb41802e8e7b01"
    sha256 cellar: :any_skip_relocation, x86_64_linux: "9dbc00f7367e57e50a5450eda90b8a1d111af2aa205bcb45a4db7acbb3e555c4"
  end
