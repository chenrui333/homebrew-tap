class Ifstate < Formula
  ...
  url "https://codeberg.org/liske/ifstate/archive/2.3.0-pre2.tar.gz"
  sha256 "6d3b0ed48358366bb233a19d6d92979ab4f40fd68b295e50818273c644202075"
  license "MIT"
  head "https://codeberg.org/liske/ifstate.git", branch: "master"

  bottle do
    root_url "https://ghcr.io/v2/chenrui333/tap"
    sha256 cellar: :any_skip_relocation, arm64_linux:  "77e76b613046984222a56eb224115b5e53e04f5e9accf7573eadcc433c125045"
    sha256 cellar: :any_skip_relocation, x86_64_linux: "bce2c9271872118f13ce0ea038c322ba3c7309d47a3cc38ac34a686a525e6282"
  end
