class ContextFileManager < Formula
  include Language::Python::Virtualenv

  desc "File management CLI tool for your prompts and context"
  homepage "https://docs.nhost.io/platform/cli/overview#cli-overview"
  url "https://files.pythonhosted.org/packages/b5/b4/cce34eddd8f6f4d2a24af1e4b84333dc67d7d4abd2ec0ce4c997bbe6cd25/context_file_manager-0.5.4.tar.gz"
  ...
  pypi_packages package_name: "context-file-manager[mcp]", exclude_packages: %w[certifi cryptography pydantic rpds-py]
  ...
  test do
    assert_match "No files in repository", shell_output("#{bin}/cfm list")
  end
end
