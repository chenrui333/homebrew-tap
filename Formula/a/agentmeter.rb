class Agentmeter < Formula
  ...
  desc "Cost intelligence for AI coding agents"
  homepage "https://github.com/aussiealex/agentmeter"
  url "https://files.pythonhosted.org/packages/a6/a7/58b9964a30e116aa2ea6695444edda6eb72ba8d72d95d527915fbb196005/agent_usage-0.3.0.tar.gz"
  sha256 "f6b3995f50cf6cb98e609275f69e8fb5dc4409fabb8e4fadcac651ec2d4ac7d7"
  license "Apache-2.0"
  ...
  test do
    ...
    output = shell_output("#{bin}/agentmeter stats")
    assert_match "AgentMeter Stats", output
    assert_match "No tool calls recorded.", output
  end
end
