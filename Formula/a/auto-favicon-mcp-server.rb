class AutoFaviconMcpServer < Formula
  include Language::Python::Virtualenv

  desc "MCP server for automatic favicon generation from PNG images or URLs"
  homepage "https://github.com/dh1011/auto-favicon-mcp"
  ...
  test do
    ...
    output = pipe_output("#{bin}/auto-favicon 2>&1", json, 0)
