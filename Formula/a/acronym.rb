class Acronym < Formula
  ...
  def install
    ...
    generate_completions_from_executable(bin/"acronym", shells: [:fish, :zsh], shell_parameter_format: :click)
  end

  test do
    assert_match version.to_s, shell_output("#{bin}/acronym --version")
