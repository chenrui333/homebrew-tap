class RosMcpServer < Formula
  include Language::Python::Virtualenv

  desc "Connect AI models like Claude & GPT with robots using MCP and ROS"
  homepage "https://github.com/robotmcp/ros-mcp-server"
  url "https://files.pythonhosted.org/packages/22/31/bdd2ed659369a7389ca2d88de2b7b7c2e3e2b2a470ec8c94888acfeff4d0/ros_mcp-2.1.2.tar.gz"
  sha256 "ee18c559ed3a49f5d39ff7276c614cb2c4305987b1fcea8c266c9afd10ebd109"
  license "Apache-2.0"
