class Renux < Formula
  ...
  url "https://files.pythonhosted.org/packages/00/12/92572c3b04ed7d1ac21d0106db2a86e712e9bc4ca4207cdb106b4bb53175/renux-0.4.0.tar.gz"
  sha256 "9ff689c190470291d3dcb27335ef0e60d86744477c31aacb1a09b874cdf93884"
  license "MIT"
  ...
  test do
    assert_match "Directory `invalid_dir` does not exist.", shell_output("#{bin}/renux invalid_dir Test Sample")
  end
end
