class Karmor < Formula
  ...
  license "Apache-2.0"
  head "https://github.com/kubearmor/kubearmor-client.git", branch: "master"
  ...
  test do
    ...
    output = shell_output("#{bin}/karmor probe 2>&1", 1)
    assert_match "unsupported environment or cluster not configured correctly", output
  end
end
