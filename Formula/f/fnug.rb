class Fnug < Formula
  ...
  desc "Nice lint runner"
  homepage "https://github.com/nickolaj-jepsen/fnug"
  url "https://files.pythonhosted.org/packages/b8/a8/e05f03ee8d008e002eaa4fab6d78eb40c66bd1d28ec232ff1aa2dbaa3331/fnug-0.0.27.tar.gz"
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/fnug --version")

    # do a test fnug config
    (testpath/".fnug.yml").write <<~YAML
      fnug_version: 0.1.0
      name: fnug
      linters:
        - name: test-linter
    ...
    output = shell_output("#{bin}/fnug config")
