class FastAgentMcp < Formula
  ...
  url "https://files.pythonhosted.org/packages/fc/10/9d446dbd330bf7218a47d99ee8cc7c4a09d6ad9b49dbce16923c79b77375/fast_agent_mcp-0.10.2.tar.gz"
  sha256 "dabc7b0b4791007355bf32e944f6c3f4c7e2d458cdd8542131cc942fe57c2c1d"
  license "Apache-2.0"
  head "https://github.com/evalstate/fast-agent.git", branch: "main"

  bottle do
    root_url "https://ghcr.io/v2/chenrui333/tap"
    sha256 cellar: :any, arm64_tahoe:   "26831b4dbed0348eeb5f5028676a5a89efe9dbfae2ec2e3eb9b1ab1a75ad0033"
    sha256 cellar: :any, arm64_sequoia: "33259863456a814c96674faf9e4832f962419abc3e73d2bee78b55d14e299f1f"
    sha256 cellar: :any, arm64_sonoma:  "6a090e6803bcc5f92d19bbee624ca770d69fd4e75a938e9dad79a475579cc83b"
    sha256 cellar: :any, arm64_linux:   "1f52e8e50d9292e185fc8d68d6dc1dc16f7099eadfca2493cb1d6edd125eb433"
    sha256 cellar: :any, x86_64_linux:  "ac6498ef6d44f845f4a78d6b1ee6bf999f25f4ac3e04678c604b3ccd60a229ab"
  end
  ...
  resource "fastmcp-slim" do
    url "https://files.pythonhosted.org/packages/b8/ec/c7d2f91ea6027fa92240ba25bb0d7601b9e1f5f5e69f079bb0ee203df403/fastmcp_slim-4.0.0b2.tar.gz"
    sha256 "b222d52c4883695f2bafb973c6fd55694bbcc8eaaa64886ebb2168d0267add3c"
  end
  ...
  resource "httpx-aiohttp" do
    url "https://files.pythonhosted.org/packages/4c/87/3b2df9732a497403e5f4bbf2ec9f25427d53cec797e83070c503649863ef/httpx_aiohttp-0.2.0.tar.gz"
