class GuardianRuntime < Formula
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/guardian_runtime --version")

    output = shell_output("#{bin}/guardian_runtime status")
    assert_match "GuardianRuntime", output
