class Sot < Formula
  ...
  url "https://files.pythonhosted.org/packages/42/1d/07c2dbc2790199705840668ba3ce2f8becbacc129d55b4cfc04d25e0b6f4/sot-4.4.1.tar.gz"
  sha256 "399f3200ae548ecd0a05221d5962d02a94c956e0c42adf94705d808312e722e7"
  license "MIT"
  ...
  test do
    ...
    pid = spawn bin/"sot", [:out, :err] => output_log.to_s
    sleep 1
    assert_match "System Observation Tool", output_log.read
  ensure
