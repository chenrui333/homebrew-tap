class Starlit < Formula
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, all: "aa7c043231fccf9d33103785ceba7acc4ff1d4c3b426ad2269c39c0df1b037fd"
  end
  ...
  resource "rich-gradient" do
    url "https://files.pythonhosted.org/packages/12/3a/70d67193d8cfa97b8c3077061c2f04ccbc6a00c0f984f6b1415215f16875/rich_gradient-0.3.6.tar.gz"
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/starlit --version")
  end
end
