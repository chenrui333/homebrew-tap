class Sephera < Formula
  include Language::Python::Virtualenv

  desc "Count, stat, and analyze your project"
  homepage "https://reim-developer.github.io/Sephera/"
  url "https://files.pythonhosted.org/packages/d4/95/51e8c5e15216c6aecfaa7243567d9dece325150ea4fb406b8d1ff91a0872/sephera-2.3.2.tar.gz"
  ...
  test do
    ...
    output = shell_output("#{bin}/sephera loc")

    assert_match <<~EOS, output
      ┏━━━━━━━━━━┳━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━┳━━━━━━━━━━━┓
      ┃ Language ┃ Code lines ┃ Comments lines ┃ Empty lines ┃ Size (MB) ┃
      ┡━━━━━━━━━━╇━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━╇━━━━━━━━━━━┩
      │ Ruby     │          1 │              1 │           0 │      0.00 │
      │ JSON     │       6224 │            N/A │           0 │      0.17 │
      │ Markdown │          2 │            N/A │           1 │      0.00 │
      └──────────┴────────────┴────────────────┴─────────────┴───────────┘
    EOS

    assert_match "Language(s) used: 3 language(s)", output
  end
end
