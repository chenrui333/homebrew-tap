class Squall < Formula
  include Language::Python::Virtualenv

  desc "TUI SQLite Viewer and Editor"
  homepage "https://github.com/driscollis/squall"
  url "https://files.pythonhosted.org/packages/ad/6f/288bb063c1755774b95830e95bd89d3459204ad1b962e5efee50f67d4c58/squall_sql-0.1.8.tar.gz"
  ...
  test do
    ...
    output = shell_output("#{bin}/squall -f #{testpath}/test.db 2>&1")
    assert_match "IndexError: list index out of range", output
  end
end
