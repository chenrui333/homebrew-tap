class McpRedis < Formula
  include Language::Python::Virtualenv

  desc "Removes unused imports and unused variables as reported by pyflakes"
  homepage "https://github.com/redis/mcp-redis"
  url "https://github.com/redis/mcp-redis/archive/refs/tags/0.2.0.tar.gz"
  sha256 "47de70c0c5a86040726b60c1b9e8655716779cec5501b3cb23fade645acee603"
  license "MIT"
  ...
  resource "dotenv" do
    url "https://files.pythonhosted.org/packages/e2/46/3754073706e31670eed18bfa8a879305b56a471db15f20523c2427b10078/dotenv-0.0.5.tar.gz"
    sha256 "b58d2ab3f83dbd4f8a362b21158a606bee87317a9444485566b3c8f0af847091"
  end
