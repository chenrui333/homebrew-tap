class Nbcat < Formula
  ...
  desc "Preview Jupyter notebooks directly in your terminal"
  homepage "https://github.com/akopdev/nbcat"
  url "https://files.pythonhosted.org/packages/7a/f0/928e7337b2c9c5f38426c592608d21b5fba19cacb7fc6c76e40a7ac4c176/nbcat-1.0.0.tar.gz"
  sha256 "6b039b7d75ea0da3deee8796e3f30b4a1b4c3cf3d5decac197b201e0090b5b6d"
  license "MIT"
  ...
  test do
    (testpath/"sample.ipynb").write <<~JSON
      {
        "cells": [
          {
            "cell_type": "markdown",
    ...
    output = shell_output("#{bin}/nbcat #{testpath/"sample.ipynb"}")
    assert_match "Sample Notebook", output
    assert_match "Notebook preview works.", output
    assert_match "hello from nbcat", output
  end
end
