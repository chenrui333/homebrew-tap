class Nless < Formula
  ...
  desc "Excel for your logs — pipe in anything, wrangle it into columns"
  homepage "https://github.com/mpryor/nothing-less"
  url "https://files.pythonhosted.org/packages/82/e9/b328cbef5fc32ef7ed7adcd8b372eac579d0fafe3820c80a8513b0166f1f/nothing_less-1.17.0.tar.gz"
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/nless --version 2>&1")
  end
end
