...
**Last Updated:** 2026-09-24 14:01:32
...
|------|-------------|------|
| knife | A reverse engineering CLI and TUI for PE, ELF and Mach-O binaries. | https://github.com/bl4ckr0ss3/knife |
| iredis | An interactive redis client with autocompletion and syntax highlighting. | https://github.com/laixintao/iredis |
| abtop | Like btop, but for your AI coding agents. | https://github.com/graykode/abtop |
| numr | A text calculator for natural language expressions with a vim-style TUI. | https://github.com/nasedkinpv/numr |
| upmd ⭐ | Run tasks and workflows from Markdown. | https://github.com/rezigned/upmd |
| grut | A terminal file explorer with deep Git integration. | https://github.com/jongio/grut/ |
